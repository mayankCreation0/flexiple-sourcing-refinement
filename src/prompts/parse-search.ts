 ...
 * Prompt: parse-search
 *
 * Transforms a recruiter's free-text requirement into structured objective filters
 * and a subjective fit rubric for the sourcing refinement loop.
 */

export const PARSE_SEARCH_SYSTEM_PROMPT = `
...
/** @deprecated Use PARSE_SEARCH_SYSTEM_PROMPT */
export const PARSE_REQUIREMENTS_SYSTEM_PROMPT = PARSE_SEARCH_SYSTEM_PROMPT;

/** @deprecated Use buildParseSearchPrompt */
export const buildParseRequirementsPrompt = buildParseSearchPrompt;
