...
/**
 * Prompt Template: refineSearchPrompt
 * 
 * Purpose: Takes the recruiter's feedback (free-form chat and/or per-profile thumbs up/down),
 * the currently presented candidates, the active filters, and the current rubric.
 * Produces adjusted objective filters and subjective rubric, and explains WHAT changed and WHY.
 */
