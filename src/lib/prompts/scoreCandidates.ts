import { CandidateProfile, SubjectiveRubric } from '../types';

/**
 * Prompt Template: scoreCandidatesPrompt
 * 
 * Purpose: Evaluates candidate profiles against the subjective fit rubric and
 * produces a quantitative fit score (0-100), verdict, and a crisp, grounded
 * explanation that cites specific profile fields (company names, years, skills, etc.).
 */
